...
% miss_can -> Resolve o problema dos Missionários e dos Canibais, sendo que começam 3 canibais e 3 missionários na margem esquerda, e têm que acabar na margem direita,
%             sabendo que o barco só pode transportar, no máximo, 2 pessoas, e que o número de canibais não pode ser superior ao número de missionários em qualquer margem do rio.
miss_can :-
    inicial(Ei), final(Ef),
